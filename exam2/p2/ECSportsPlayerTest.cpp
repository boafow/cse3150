...
void Test()
{
  ...
  ECSportsPlayerWildcard p7iw(p7);
  ECSportsPlayerDisciplined p7i(p7iw, 6,7);
  bool f7 = p7i.CanPlay(trATPMaster);
  if( f7 )
  {
  ...
  // player 8: rank 100, wildcard, displined from Feb to April, injured in Jan. NOT qualified.
  ECSportsPlayerRanked p8(100);
  ECSportsPlayerDisciplined p8d(p8, 2, 4);
  ECSportsPlayerWildcard p8dw(p8d);
  ECSportsPlayerInjured p8dwi(p8dw, 1);
  bool f8 = p8dwi.CanPlay(trATPMaster);
  if( f8 )
  {
    cout << "Player 8: qualified\n";
  }
  else
  {
    cout << "Player 8: NOT qualified\n";
  }
}
