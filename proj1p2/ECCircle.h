...
public:
    ...
    ECCircle(double x, double y, double radius): xcenter(x), ycenter(y), radius(radius){};
...
public:
    ...
    ECEllipse(double x, double y, double radiusx, double radiusy): xcenter(x), ycenter(y), radiusx(radiusx), radiusy(radiusy){};
