...
void Test0()
{
  ...
  sim.AddDailyEvent(1, indPopo, 1, 0);
  sim.AddDailyEvent(2, indFofo, 1, 1);
  sim.AddDailyEvent(9, indFofo, 1, 0);
  sim.AddDailyEvent(10, indFofo, 0, 0);
  ...
  cout << "fofo vitality: " << sim.GetVitalityFor("fofo")-20 << endl;
}
...
//   double dur = sim.Simulate(tmStart, tmLimit);
//   cout << "Duration of simulation 1: " << dur << endl;
// }
...
//     double dur = sim.Simulate(tmStart, tmLimit);
//     cout << "Duration of simulation 2: " << dur << endl;
...
//     double dur = sim.Simulate(tmStart, tmLimit);
//     cout << "Duration of simulation 3: " << dur << endl;
...
//     double dur = sim.Simulate(tmStart, tmLimit);
//     cout << "Duration of simulation 4: " << dur << endl;
// }
...
//     cout << "Duration of simulation 5: " << dur << endl;
...
//     double dur = sim.Simulate(tmStart, tmLimit);
//     cout << "Duration of simulation 6: " << dur << endl;
// }
...
//     double dur = sim.Simulate(tmStart, tmLimit);
//     cout << "Duration of simulation 7: " << dur << endl;
// }
